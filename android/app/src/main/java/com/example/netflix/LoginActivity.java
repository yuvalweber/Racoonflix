...
public class LoginActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Initialize UserRepository with API service and database
		...
		buttonLogin.setOnClickListener(v -> {
			...
			// Perform login using UserRepository
					...
					new Thread(() -> {
						...
						runOnUiThread(() -> {
							if (tokenEntity != null) {
								...
								// Navigate to ConnectedHomePageActivity on successful login
								Intent intent = new Intent(LoginActivity.this, ConnectedHomePageActivity.class);

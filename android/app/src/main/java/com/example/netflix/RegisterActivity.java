/**
 * RegisterActivity is an activity that handles user registration.
 * It collects user input, validates it, and sends it to the server to create a new user account.
 */
